...
class HttpURLConnectionExampleCheck {
...
//    private static final String POST_URL = "http://192.168.122.1:8000/";
    ...
    public static void mainentryFunction(String data) throws IOException {

        System.out.println("-------------------Check Nested 1 ------------------------");

//        sendGET();
        System.out.println("GET DONE");
        sendPOST(data);
        System.out.println("POST DONE");
        System.out.println("-------------------Check Nested 1 End ------------------------");
    }
...
public class HttpUploadPlugin extends OutputPlugin
{
    ...
    public void processIntent(Intent intent)
    {
        ...
        //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
        if (this.enableDataServer(prefs) == true)
            return;
...
//                                        .getResources().getString(R.string.sensor_upload_url));
                                ...
                                String jsonString22 = jsonMessage.toString();
//                                System.out.println(jsonString22);
                                HttpURLConnectionExampleCheck.mainentryFunction(jsonString22);
